...
static const Animation char_gf_anim[CharAnim_Max] = {
	...
	{12, (const u8[]){17, 18, ASCR_BACK, 1}},                                 //CharAnim_Left
	{24, (const u8[]){ 0,  0,  1,  1,  2,  2,  3,  4,  4,  5, ASCR_BACK, 1}}, //CharAnim_LeftAlt
	{12, (const u8[]){19, 20, ASCR_BACK, 1}},                                 //CharAnim_Down
	{24, (const u8[]){12, 13, 14, 15, 16, ASCR_REPEAT}},                      //CharAnim_DownAlt
	{12, (const u8[]){21, 22, ASCR_BACK, 1}},                                 //CharAnim_Up
	{12, (const u8[]){25, 26, ASCR_BACK, 1}},                                 //CharAnim_UpAlt
	{12, (const u8[]){23, 24, ASCR_BACK, 1}},                                 //CharAnim_Right
	{24, (const u8[]){ 6,  6,  7,  7,  8,  8,  9, 10, 10, 11, ASCR_BACK, 1}}, //CharAnim_RightAlt
};
